...
- Fixed Claude Desktop refusing the connector - the server instructions no longer read as an attempt to override assistant behavior
- Rewrote the copyable Claude custom instructions: teaches the "LL" shorthand and works with Claude Desktop's "Load tools when needed" mode
- Fixed garbled dashes when copying those instructions on macOS and Windows
- check_app_status and get_license_status now mention LL/LocalLens so the connector is discoverable when tools load on demand
...
| Platform | File | Type |
|----------|------|------|
| macOS (Apple Silicon) | [locallens-agent-macos-arm64.dmg](https://github.com/ashesbloom/locallens_mcp_agent/releases/download/v1.0.29/locallens-agent-v1.0.29-macos-arm64.dmg) | Menu Bar App |
| macOS (Apple Silicon) | [locallens-mcp-macos-arm64.zip](https://github.com/ashesbloom/locallens_mcp_agent/releases/download/v1.0.29/locallens-mcp-v1.0.29-macos-arm64.zip) | MCP Binary |
| Windows (x64) | [locallens-mcp-windows-x86_64.zip](https://github.com/ashesbloom/locallens_mcp_agent/releases/download/v1.0.29/locallens-mcp-v1.0.29-windows-x86_64.zip) | MCP Binary |
| Linux (x64) | [locallens-mcp-linux-x86_64.tar.gz](https://github.com/ashesbloom/locallens_mcp_agent/releases/download/v1.0.29/locallens-mcp-v1.0.29-linux-x86_64.tar.gz) | MCP Binary |
...
1. Download `locallens-agent-v1.0.29-macos-arm64.dmg`
...
\`\`\`bash
# Extract and set up
tar -xzf locallens-mcp-v1.0.29-macos-arm64.tar.gz   # or .zip on macOS
