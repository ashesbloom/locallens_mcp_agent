...
- Pinned the mcp dependency below 2.0.0 - mcp 2.0.0 removed mcp.server.fastmcp, which broke the v1.0.29 binaries and the macOS app bundle build
- v1.0.29 binaries are unusable and its macOS DMG was never published; upgrade straight to v1.0.30
...
| Platform | File | Type |
|----------|------|------|
| macOS (Apple Silicon) | [locallens-agent-macos-arm64.dmg](https://github.com/ashesbloom/locallens_mcp_agent/releases/download/v1.0.30/locallens-agent-v1.0.30-macos-arm64.dmg) | Menu Bar App |
| macOS (Apple Silicon) | [locallens-mcp-macos-arm64.zip](https://github.com/ashesbloom/locallens_mcp_agent/releases/download/v1.0.30/locallens-mcp-v1.0.30-macos-arm64.zip) | MCP Binary |
| Windows (x64) | [locallens-mcp-windows-x86_64.zip](https://github.com/ashesbloom/locallens_mcp_agent/releases/download/v1.0.30/locallens-mcp-v1.0.30-windows-x86_64.zip) | MCP Binary |
| Linux (x64) | [locallens-mcp-linux-x86_64.tar.gz](https://github.com/ashesbloom/locallens_mcp_agent/releases/download/v1.0.30/locallens-mcp-v1.0.30-linux-x86_64.tar.gz) | MCP Binary |
...
1. Download `locallens-agent-v1.0.30-macos-arm64.dmg`
...
\`\`\`bash
# Extract and set up
tar -xzf locallens-mcp-v1.0.30-macos-arm64.tar.gz   # or .zip on macOS
