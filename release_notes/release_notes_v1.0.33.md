...
1. Download [`locallens-agent-v1.0.33-macos-arm64.dmg`](https://github.com/ashesbloom/locallens_mcp_agent/releases/download/v1.0.33/locallens-agent-v1.0.33-macos-arm64.dmg)
...
1. Download [`locallens-agent-v1.0.33-windows-x86_64-setup.exe`](https://github.com/ashesbloom/locallens_mcp_agent/releases/download/v1.0.33/locallens-agent-v1.0.33-windows-x86_64-setup.exe)
...
| Platform | File | Type |
|---|---|---|
| macOS (Apple Silicon) | [locallens-agent-v1.0.33-macos-arm64.dmg](https://github.com/ashesbloom/locallens_mcp_agent/releases/download/v1.0.33/locallens-agent-v1.0.33-macos-arm64.dmg) | Menu Bar App |
| Windows (x64) | [locallens-agent-v1.0.33-windows-x86_64-setup.exe](https://github.com/ashesbloom/locallens_mcp_agent/releases/download/v1.0.33/locallens-agent-v1.0.33-windows-x86_64-setup.exe) | Installer |
| macOS (Apple Silicon) | [locallens-mcp-v1.0.33-macos-arm64.zip](https://github.com/ashesbloom/locallens_mcp_agent/releases/download/v1.0.33/locallens-mcp-v1.0.33-macos-arm64.zip) | MCP Binary |
| Windows (x64) | [locallens-mcp-v1.0.33-windows-x86_64.zip](https://github.com/ashesbloom/locallens_mcp_agent/releases/download/v1.0.33/locallens-mcp-v1.0.33-windows-x86_64.zip) | MCP Binary |
| Linux (x64) | [locallens-mcp-v1.0.33-linux-x86_64.tar.gz](https://github.com/ashesbloom/locallens_mcp_agent/releases/download/v1.0.33/locallens-mcp-v1.0.33-linux-x86_64.tar.gz) | MCP Binary |
