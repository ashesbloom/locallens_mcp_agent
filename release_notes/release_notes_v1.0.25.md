...
- Fixed critical LLM sorting logic to block People sort when no faces are enrolled and set wait_for_completion=True by default.
- Fixed Windows process management, UTF-16LE clipboard encoding, MSIX log path detection, and daemon PID existence verification.
- Organized project repository structure into cleanly separated docs/, scripts/, and release_notes/ directories.
...
| Platform | File | Type |
|----------|------|------|
| macOS (Apple Silicon) | [locallens-agent-macos-arm64.dmg](https://github.com/ashesbloom/locallens_mcp_agent/releases/download/v1.0.25/locallens-agent-v1.0.25-macos-arm64.dmg) | Menu Bar App |
| macOS (Apple Silicon) | [locallens-mcp-macos-arm64.zip](https://github.com/ashesbloom/locallens_mcp_agent/releases/download/v1.0.25/locallens-mcp-v1.0.25-macos-arm64.zip) | MCP Binary |
| Windows (x64) | [locallens-mcp-windows-x86_64.zip](https://github.com/ashesbloom/locallens_mcp_agent/releases/download/v1.0.25/locallens-mcp-v1.0.25-windows-x86_64.zip) | MCP Binary |
| Linux (x64) | [locallens-mcp-linux-x86_64.tar.gz](https://github.com/ashesbloom/locallens_mcp_agent/releases/download/v1.0.25/locallens-mcp-v1.0.25-linux-x86_64.tar.gz) | MCP Binary |
...
1. Download `locallens-agent-v1.0.25-macos-arm64.dmg`
...
\`\`\`bash
# Extract and set up
tar -xzf locallens-mcp-v1.0.25-macos-arm64.tar.gz   # or .zip on macOS
