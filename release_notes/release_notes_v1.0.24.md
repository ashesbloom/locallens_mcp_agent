...
- Fix Windows MSIX config path bug for Claude Desktop Connector
...
| Platform | File | Type |
|----------|------|------|
| macOS (Apple Silicon) | [locallens-agent-macos-arm64.dmg](https://github.com/ashesbloom/locallens_mcp_agent/releases/download/v1.0.24/locallens-agent-v1.0.24-macos-arm64.dmg) | Menu Bar App |
| macOS (Apple Silicon) | [locallens-mcp-macos-arm64.zip](https://github.com/ashesbloom/locallens_mcp_agent/releases/download/v1.0.24/locallens-mcp-v1.0.24-macos-arm64.zip) | MCP Binary |
| Windows (x64) | [locallens-mcp-windows-x86_64.zip](https://github.com/ashesbloom/locallens_mcp_agent/releases/download/v1.0.24/locallens-mcp-v1.0.24-windows-x86_64.zip) | MCP Binary |
| Linux (x64) | [locallens-mcp-linux-x86_64.tar.gz](https://github.com/ashesbloom/locallens_mcp_agent/releases/download/v1.0.24/locallens-mcp-v1.0.24-linux-x86_64.tar.gz) | MCP Binary |
...
1. Download `locallens-agent-v1.0.24-macos-arm64.dmg`
...
\`\`\`bash
# Extract and set up
tar -xzf locallens-mcp-v1.0.24-macos-arm64.tar.gz   # or .zip on macOS
